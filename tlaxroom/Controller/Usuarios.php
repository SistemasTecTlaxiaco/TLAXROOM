...
class Usuarios extends Controllers
{
    ...
    public function insertar()
    {
        ...
        $data = $this->model->selectUsuarios();
        header("location: " . URL_BASE() . "Usuarios/Listar?msg=$alert");
        die();
    }
    ...
    public function eliminar()
    {
        ...
        $data = $this->model->selectUsuarios();
        header("location: " . URL_BASE() . "Usuarios/Listar");
        die();
    }
    ...
    public function login()
    {
        if (!empty($_POST['usuario']) || !empty($_POST['clave'])) {
            ...
            if (!empty($data)) {
                    ...
                    header('location: '.URL_BASE(). 'Admin/Listar');
            } else {
                $error = 0;
                header("location: ".URL_BASE()."?msg=$error");
            }
        }
    }
