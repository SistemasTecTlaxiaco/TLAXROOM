        <footer class="footer">
            <div class="footer__block block no-margin-bottom">
                <div class="container-fluid text-center">
                    ...
                    <p class="no-margin-bottom"><?php echo date("Y"); ?> &copy; TLAXROOM<a href="#">ADMINISTRADOR</a> </p>
                </div>
            </div>
        </footer>
        </div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer ml-auto">
                        <a href="<?php echo URL_BASE(); ?>Usuarios/salir" class="btn btn-danger">Si</a>
        ...
        <script src="<?php echo URL_BASE(); ?>Assets/js/Funciones.js"></script>
        <script src="<?php echo URL_BASE(); ?>Assets/js/chartjs.min.js"></script>
        <script src="<?php echo URL_BASE(); ?>Assets/js/all.min.js"></script>
        <script src="<?php echo URL_BASE(); ?>Assets/js/front.js"></script>
        <script src="<?php echo URL_BASE(); ?>Assets/js/sweetalert2@9.js"></script>
        <script src="<?php echo URL_BASE(); ?>Assets/js/jquery.dataTables.min.js"></script>
        <script src="<?php echo URL_BASE(); ?>Assets/DataTables/DataTables-1.10.21/js/dataTables.bootstrap4.min.js" type="text/javascript"></script>
