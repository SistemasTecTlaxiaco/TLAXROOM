            ...
            <div class="col-lg-4 m-auto">
                <div class="card mt-5">
                    <div class="card-header bg-primary text-center">
                        ...
                        <img class="img-thumbnail" src="<?php echo URL_BASE(); ?>/Assets/img/logo_tlax_room.png" width="100">
                    </div>
                    <div class="card-body">
                        ...
                        <?php } ?>
                        <form action="<?php echo URL_BASE(); ?>Usuarios/login" method="post" autocomplete="off">
