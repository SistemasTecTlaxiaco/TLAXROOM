                ...
                <div class="col-lg-12 mt-2">
                    <div class="row">
                        <div class="col-lg-6 mb-2">
                            ...
                            <a href="<?php echo URL_BASE(); ?>/Usuarios/eliminados" class="btn btn-danger">Inactivos</a>
                        </div>
                        <div class="col-lg-6">
                            ...
                            <tbody>
                                <?php foreach ($data as $us) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?php echo URL_BASE() ?>Usuarios/editar?id=<?php echo $us['id']; ?>" class="btn btn-primary">Editar</a>
                                            <form action="<?php echo URL_BASE() ?>Usuarios/eliminar?id=<?php echo $us['id']; ?>" method="post" class="d-inline elim">
...
<div id="nuevo_cliente" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="my-modal-title" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form method="post" action="<?php echo URL_BASE(); ?>Usuarios/insertar" autocomplete="off">
